...
struct memory_desc_wrapper: public c_compatible {
    ...
    size_t size() const {
        ...
        assert(utils::one_of(format(), blocked, x, nc, nchw, nhwc, chwn, ndhwc, ncdhw, oidhw,dhwio, goidhw,
                    ...
                    nCdhw16c, oIdhw16i, OIdhw16o16i, gOIdhw16o16i, OIdhw16i16o,
                    gOIdhw16i16o, Oidhw16o, gOidhw16o));
