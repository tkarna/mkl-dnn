...
void jit_avx512_common_conv3D_fwd_kernel::prepare_output(int ur_w)
{
...
void jit_avx512_common_conv3D_fwd_kernel::store_output(int ur_w)
{
...
void jit_avx512_common_conv3D_fwd_kernel::compute_loop_4fma_1st(int ur_w,
        int pad_l, int pad_r)
{
...
void jit_avx512_common_conv3D_fwd_kernel::compute_loop_4fma(int ur_w,
        int pad_l, int pad_r)
{
    int stride_w = jcp.stride_w;
    int ic_block = jcp.ic_block;
...
void jit_avx512_common_conv3D_fwd_kernel::compute_loop_fma(int ur_w, int pad_l,
        int pad_r)
{
    bool prf_ker = true;
    bool prf_inp = true;
...
void jit_avx512_common_conv3D_fwd_kernel::compute_loop_fma_core(int ur_w,
    int pad_l, int pad_r)
{
    int kw = jcp.kw;
    int stride_w = jcp.stride_w;
...
void jit_avx512_common_conv3D_fwd_kernel::compute_loop_4vnni(
...
void jit_avx512_common_conv3D_fwd_kernel::compute_loop(int ur_w,
        int pad_l, int pad_r)
{
...
void jit_avx512_common_conv3D_fwd_kernel::generate()
{
    int iw = jcp.iw;
    int ow = jcp.ow;
    int kw = jcp.kw;
...
bool jit_avx512_common_conv3D_fwd_kernel::post_ops_ok(
...
void jit_avx512_common_conv3D_bwd_data_kernel_f32::prepare_output(int ur_w)
{
...
void jit_avx512_common_conv3D_bwd_data_kernel_f32::store_output(int ur_w)
{
...
void jit_avx512_common_conv3D_bwd_data_kernel_f32::compute_loop_4fma(int ur_w,
...
void jit_avx512_common_conv3D_bwd_data_kernel_f32::compute_loop_4vnni(int ur_w,
        int l_overflow, int r_overflow)
{
    int ow = jcp.ow;
    int kw = jcp.kw;
...
void jit_avx512_common_conv3D_bwd_data_kernel_f32::compute_loop_fma(int ur_w,
        int l_overflow, int r_overflow)
{
    Label kh_label;
...
void jit_avx512_common_conv3D_bwd_data_kernel_f32::compute_loop_fma_core(int ur_w,
    int l_overflow, int r_overflow)
{
    int kw = jcp.kw;
    int ow = jcp.ow;
...
inline void jit_avx512_common_conv3D_bwd_data_kernel_f32::compute_loop(int ur_w,
        int l_overflow, int r_overflow)
{
    if (jcp.ver == ver_4vnni)
