...
void ref_pooling3D_fwd_t<data_type, acc_type>::execute_forward() {
...
template <data_type_t data_type, data_type_t acc_type>
void ref_pooling3D_bwd_t<data_type, acc_type>::execute_backward() {
    using namespace alg_kind;
...
template struct ref_pooling3D_fwd_t<data_type::f32>;
template struct ref_pooling3D_fwd_t<data_type::s32>;
template struct ref_pooling3D_fwd_t<data_type::s16, data_type::s32>;
template struct ref_pooling3D_fwd_t<data_type::s8, data_type::s32>;
template struct ref_pooling3D_fwd_t<data_type::u8, data_type::s32>;

template struct ref_pooling3D_bwd_t<data_type::f32>;
template struct ref_pooling3D_bwd_t<data_type::s32>;
template struct ref_pooling3D_bwd_t<data_type::s16, data_type::s32>;
