...
#include "cpu/jit_avx512_common_pooling3D.hpp"
...
#include "cpu/jit_avx512_common_convolution3D_1ch.hpp"
...
static const pd_create_f cpu_impl_list[] = {
    ...
    INSTANCE(jit_avx512_common_convolution3D_bwd_weights_t<f32, f32, f32, f32>),
    ...
    /* pool */
    INSTANCE(jit_avx512_common_pooling3D_fwd_t<f32>),
    INSTANCE(jit_avx512_common_pooling3D_bwd_t<f32>),
