...
void ref_convolution3D_bwd_data_t<diff_src_type, wei_type, diff_dst_type,
...
template <data_type_t src_type, data_type_t diff_wei_type,
         data_type_t diff_dst_type, data_type_t acc_type>
void ref_convolution3D_bwd_weights_t<src_type, diff_wei_type, diff_dst_type,
...
template struct ref_convolution3D_bwd_data_t<f32, f32, f32, f32>;
template struct ref_convolution3D_bwd_data_t<s32, s16, s16, s32>;

template struct ref_convolution3D_bwd_weights_t<f32, f32, f32, f32>;
template struct ref_convolution3D_bwd_weights_t<s16, s32, s16, s32>;
